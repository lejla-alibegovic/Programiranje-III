...
class Korisnik {
	...
	char* _imePrezime;
	//char * - se odnosi na naziv predmeta ili tema gdje ?e se ?uvati kompletna komunikacija sa nastavnim osobljem ili korisnikom na odre?enom predmetu/temi
...
void main()
{
	...
	5. NAZIVI FUNKCIJA, TE BROJ I TIP PARAMETARA MORAJU BITI IDENTI?NI ONIMA KOJI SU KORIŠTENI U TESTNOM CODE-U, OSIM U SLU?AJU DA POSTOJI ADEKVATAN RAZLOG ZA NJIHOVU MODIFIKACIJU. OSTALE, POMO?NE FUNKCIJE MOŽETE IMENOVATI I DODAVATI PO ŽELJI.
